          ...
          <div className='bg-gray-900'>
                  ...
                  <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                      <div>
                          ...
                          <ul className='mt-2 space-y-2'>
                              ...
                              <li>
                                  <a href="" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Gamed</a>
                              </li>
                              <li>
                      ...
                      <div>
                          ...
                          <ul className='mt-2 span-y-2'>
                              ...
                              <li>
                                  <a href="" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Protoflio</a>
                              </li>
                          </ul>
                    </div>
                    ...
                    {/* subscripe */}
                        <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                          <p className='font-medium tracking-wide text-gray-300'>Subscripe for update</p>
                         <form className='mt-4 flex flex-col md:flex-row' >
                          <input type="text" className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none' /> 
                            <button type='submit' className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white trasition duration-200 rouded shadow-md hover:bg-orange-500 focus:outline-none border'>
                          subscribe
                      </button>
              ...
              <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
                  <p className='text-sm text-gray-500'>
                      ©Copyright 2025 | All righy reserved.
                  </p>
